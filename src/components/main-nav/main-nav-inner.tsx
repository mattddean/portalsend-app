            ...
            <NavigationMenuItem>
              ...
              <NavigationMenuContent>
                <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                  ...
                  <ListItem href="/files/sent" title="Sent Files">
                    Files you&rsquo;ve sent to others.
                  </ListItem>
                  <ListItem href="/files/received" title="Received Files">
                    Files you&rsquo;ve received from others.
                  </ListItem>
                </ul>
              </NavigationMenuContent>
            </NavigationMenuItem>
